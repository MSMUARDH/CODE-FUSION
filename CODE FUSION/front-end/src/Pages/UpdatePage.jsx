        ...
        <div className="col-lg-6 col-md-8 col-sm-12">
          ...
          <form onSubmit={handleSubmit}>
            <MDBContainer className="mb-3">
              <MDBRadio
                checked={rdobtnvalue === "Work"}
                name="inlineRadio"
                id="inlineRadio1"
                onChange={(e) => setRdobtnvalue(e.target.value)}
                label="Work"
                value="Work"
                inline
              />
              <MDBRadio
                checked={rdobtnvalue === "Personal"}
                onChange={(e) => setRdobtnvalue(e.target.value)}
                name="inlineRadio"
                id="inlineRadio2"
                value="Personal"
